...
typedef struct{
	...
	uint16_t WHRtg_SF; //			sunssf
	uint16_t WMaxChaDisCha_SF; //			sunssf
	uint16_t DisChaRte_SF; //			sunssf
	uint16_t SoC_SF; //			sunssf
	uint16_t Pad; // 		pad
}MESA_DATA_801;
...
typedef struct{
	...
	uint16_t SoH_SF;		//			sunssf
	uint16_t Vol_SF;		//			sunssf
	uint16_t MaxBatA_SF;		//			sunssf
	uint16_t BatReqW_SF;		//			sunssf
}MESA_DATA_802;		
...
uint16_t BCellVol_SF;		//				sunssf			R	M	Scale factor for cell voltage.	
uint16_t BModTmp_SF;		//				sunssf			R	M	Scale factor for module temperatures.	
uint16_t BCurrent_SF;		//				sunssf			R	M	Scale factor for Total DC Current, Max String Current and Min String Current.	
uint16_t StrSoH_SF;		//				sunssf			R	O	Scale factor for String State of Health.	
